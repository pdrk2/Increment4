   ...
   <asp:Panel id="pan2" runat="server" ScrollBars="Auto" Height="489px" > 
           ...
           <asp:Repeater ID="venven" runat="server">
    		...
    		<div style="float:left;width:300px; ">
    			<h5 class="cufon" ><a style="color:aqua" href="venue_profile.aspx?vendor_name=<%#DataBinder.Eval(Container.DataItem, "vendor_name")%>"><%#  DataBinder.Eval(Container.DataItem, "vendor_name")%></a></h5>
