<%@ Page Title="" Language="C#" MasterPageFile="~/FinalUser.Master" AutoEventWireup="true" CodeBehind="order_single.aspx.cs" Inherits="ASE_Project.order_single" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <p>
      ...
      <div style="float:right;">
    			<strong  style="margin-right: 900px; color:aqua" class="price">Price</strong> 
    		</div>
        <div class="clear"></div>
        <br />
    		...
    		<div style="float:right;color:white">
    			<strong  style="margin-right: 900px;" class="price">$  <%# DataBinder.Eval(Container.DataItem, "price")%></strong> 
    		</div>
 </div>
 <br class="clear">
 <br>
        ...
        <label>Sub Total:</label>
         <div style="float:right;color:red">
    			 <strong  style="margin-right: 900px;" class="price">$ <asp:Label ID="price1" runat="server" Text="0" Visible="true"></asp:Label></strong> 
    		</div>
            <br />
            <br />
<!--
