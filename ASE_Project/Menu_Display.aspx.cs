...
{
    public partial class Menu_Display : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            
           string v2 = Request.QueryString["vname"];
           // string main_vname = Session["main_vname"].ToString();    
          //  v2 = Session["vn"].ToString();
            Label3.Visible = true;
            ...
            // goback.Text = "<a href='vendor_single.aspx' class='green'> Go Back</a>";

            ArrayList a = new ArrayList(r1.menu_retrieve(v2));*/
            ArrayList b = new ArrayList();

            SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["dbString"].ConnectionString);
            conn.Open();

            SqlCommand cmd = new SqlCommand("select * from item_menus where vendor_name = '" + v2 + "'", conn);
