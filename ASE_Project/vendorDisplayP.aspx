   ...
   <asp:Panel id="pan2" runat="server" ScrollBars="Auto" Height="489px" > 
           ...
           <asp:Repeater ID="venphoto" runat="server">
    		...
    		<div style="float:left; width:300px; ">
    			<h5 class="cufon" ><a style="color:aqua" href="photo_profile.aspx?vendor_name=<%#DataBinder.Eval(Container.DataItem, "vendor_name")%>"><%#  DataBinder.Eval(Container.DataItem, "vendor_name")%></a></h5>
